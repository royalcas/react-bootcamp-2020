...
export class MedicalRecordApi {
  ...
  async addMedicalRecord(item: MedicalRecordItem, userId: string): Promise<MedicalRecordItem[]> {
    return await this._http.post<MedicalRecordItem[]>('medicalRecord', { ...item, userId });
  }
}
